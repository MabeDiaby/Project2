...
const url = `https://apidojo-forever21-v1.p.rapidapi.com/products/v2/list?categoryName=plus_size_new_arrivals&pageSize=48&pageNumber=1&sortby=0`

function PSNewArrivals(props) {
	...
	"headers": {
        ...
        .then((res) => res.json())
        .then((res) => setPNew(res.CatalogProducts))
        .catch(console.err);
        // console.log(makeup);
    }, [])
