...
const url = `https://apidojo-forever21-v1.p.rapidapi.com/products/v2/list?categoryName=plus_size_bottom&pageSize=48&pageNumber=1&sortby=0`

function PSBottom(props) {
	...
	"headers": {
        ...
        .then((res) => res.json())
        .then((res) => setPants(res.CatalogProducts))
        .catch(console.err);
        // console.log(makeup);
    }, [])
