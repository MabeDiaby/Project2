...
const url = `https://apidojo-forever21-v1.p.rapidapi.com/products/v2/list?categoryName=sale_acc&pageSize=48&pageNumber=1&sortby=0`

function ASale(props) {
	...
	"headers": {
        ...
        .then((res) => res.json())
        .then((res) => setASale(res.CatalogProducts))
        .catch(console.err);
        // console.log(makeup);
    }, [])
