...
const url = `https://apidojo-forever21-v1.p.rapidapi.com/products/v2/list?categoryName=acc_belts&pageSize=48&pageNumber=1&sortby=0`

function ABelts(props) {
	...
	"headers": {
        ...
        .then((res) => res.json())
        .then((res) => setBelt(res.CatalogProducts))
        .catch(console.err);
        // console.log(makeup);
    }, [])
    ...
    return (
        ...
        { <section className="theSectionA">
            ...
            return (
                ...
                <img src = {brandChild.DefaultProductImage} alt="belt" />
                <div className="infoA">
