...
const url = `https://apidojo-forever21-v1.p.rapidapi.com/products/v2/list?categoryName=mens_bottom_denim&pageSize=48&pageNumber=1&sortby=0`

function MDenim(props) {
	...
	"headers": {
        ...
        .then((res) => res.json())
        .then((res) => setMJeans(res.CatalogProducts))
        .catch(console.err);
        // console.log(makeup);
    }, [])
    ...
    return (
        ...
        { <section className="theSectionM">
            {mJeans.map(brandChild => {
            return (
                    <div className="productContainerM">
                    <h3 className="productM">
                <img src = {brandChild.DefaultProductImage} alt="denim" />
                <div className="infoM">
